...
const getCounties = async (state: string): Promise<CountyData[]> => {
    ...
    const headers = ['State', 'County', 'Median_Household_Income', 'Poverty_Rate', 'Unemployment_Rate', 'Population_Density', 'Median_Age', 'Average_Age', 'Minority_Percentage', 'Female_Percentage'];
